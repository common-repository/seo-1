...
function wds_seoopt_settings() {
	...
	<p>This plugin also adds a Seo All In One module below the Write Post / Page editor which you can use to customise SEO options for individual posts and pages.</p>' , 'wds' ), WDS_PLUGIN_URL . 'images/onpagesample.png' );
