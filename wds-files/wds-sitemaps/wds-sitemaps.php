 ...
 * inspired by WordPress SEO ().
 */

/**
 * Seo 1 pages optimization classes
 *
 * @package Seo 1
 * @since 0.1
 */
...
//echo "<pre>" . var_export($sitemap_options,1)  . "</pre>";
    ...
    set_time_limit(120);
		...
		$output .= '<!-- ' . sprintf( __( 'XML Sitemap Generated by Seo 1, containing %s' , 'wds'), count($stack) ) .' URLs -->'."\n";
...
class WDS_XML_News_Sitemap extends WDS_XML_Sitemap_Base {
	...
	function generate_sitemap( $sitemapurl, $sitemappath, $echo = false) {
		...
		$output .= '<!-- ' . __( 'XML NEWS Sitemap Generated by Seo 1 ' , 'wds') . ' -->'."\n";
