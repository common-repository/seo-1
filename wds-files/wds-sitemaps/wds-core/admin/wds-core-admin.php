	...
	*/
	...
	function add_page() {
		...
		if ( ! is_multisite() || (is_multisite() && !WDS_SITEWIDE)) {
			$wds_page_hook = add_submenu_page( 'options-general.php', __( 'Seo 1 Wizard' , 'wds'), __( 'Seo 1', 'wds' ), $this->capability, 'wds_wizard', array( &$this, 'options_page' ) );
		} else if (is_multisite() && version_compare( $wp_version , '3.0.9', '>' ) ) {
			$wds_page_hook = add_submenu_page( 'settings.php', __( 'Seo 1 Wizard' , 'wds'), __( 'Seo 1', 'wds' ), $this->capability, 'wds_wizard', array( &$this, 'options_page' ) );
		} else if (is_multisite()) {
			$wds_page_hook = add_submenu_page( 'ms-admin.php', __( 'Seo 1 Wizard' , 'wds'), __( 'Seo 1', 'wds' ), $this->capability, 'wds_wizard', array( &$this, 'options_page' ) );
		}
